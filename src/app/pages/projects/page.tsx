...
const ProjectsPage = () => {
    ...
    return (
        <div className={`w-full pb-[40px] ${darkMode ? "bg-[#19191c]" : "bg-gray-200"}`}>
            <div id="projects" className="w-3/4 mx-auto">
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 px-0 md:px-[50px]">
                    {projects.map((project, index) => (
                        <div
                            key={index}
                            className={`${darkMode ? "bg-gray-700" : "bg-white"} rounded-lg shadow-lg overflow-hidden flex flex-col`}
                        >
                            <Image
                                width={1200}
                                height={900}
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                ...
                                <p className={`${darkMode ? "text-gray-200" : "text-gray-700"} mb-4 flex-grow`}>{project.description}</p>
                                <div className="mt-auto">
                                    <a
                                        target="_blank"
                                        href={project.link}
                                        className="text-white bg-purple-600 hover:bg-purple-700 py-2 px-4 rounded inline-block"
                                    >
                                        See project
                                    </a>
                                </div>
