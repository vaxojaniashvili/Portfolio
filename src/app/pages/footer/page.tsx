    ...
    <div className="bg-black flex w-full text-white justify-center px-[12%]">
      <div className="xl:flex xl:gap-0 text-white w-full justify-between py-[50px] grid gap-6">
        <div>
          ...
          <p className="text-white w-full xl:w-[600px] text-[18px]">
            Mobile Engineer & Full-Stack Web Developer specializing in creating
            robust websites and web applications that drive product success.
          </p>
        </div>
        <div>
